...
| **D3 · video** | does it survive re-synthesis? | ⏳ running |
...
- **Scale.** Neither arm established 80×60. Needs a shot with a human scale cue — wrapped fully around
  the shoulders, or two people under it — before the size claim is credible.
- **D3 video result.**
